...
final class AccountUsageDisplayFormatterTests: XCTestCase {
    func testCountUsesGroupedRawValueForSmallNumbers() {
        ...
        XCTAssertEqual(AccountUsageDisplayFormatter.count(9_999), "9,999")
    }

    func testCountUsesCompactSuffixesForLargeNumbers() {
        XCTAssertEqual(AccountUsageDisplayFormatter.count(10_000), "10K")
        XCTAssertEqual(AccountUsageDisplayFormatter.count(10_235), "10.2K")
    ...
    func testCountPreservesNegativeSign() {
        XCTAssertEqual(AccountUsageDisplayFormatter.count(-12_345), "-12.3K")
    }
}
