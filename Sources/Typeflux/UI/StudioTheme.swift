...
enum StudioTheme {
    ...
    static let accentSoft = dynamic(light: NSColor(calibratedRed: 0.875, green: 0.925, blue: 1.0, alpha: 0.62), dark: NSColor(calibratedRed: 0.18, green: 0.24, blue: 0.35, alpha: 0.78))
    static let windowBackground = dynamic(light: NSColor(calibratedWhite: 0.945, alpha: 0.78), dark: NSColor(calibratedRed: 0.055, green: 0.059, blue: 0.068, alpha: 0.76))
    static let background = dynamic(light: NSColor(calibratedWhite: 0.945, alpha: 0.78), dark: NSColor(calibratedRed: 0.055, green: 0.059, blue: 0.068, alpha: 0.76))
    static let modalSurface = dynamic(light: NSColor(calibratedWhite: 0.900, alpha: 0.92), dark: NSColor(calibratedRed: 0.078, green: 0.086, blue: 0.104, alpha: 0.94))
    static let shellSurface = dynamic(light: NSColor(calibratedWhite: 0.805, alpha: 0.68), dark: NSColor(calibratedRed: 0.105, green: 0.115, blue: 0.132, alpha: 0.70))
    static let sidebar = windowBackground
    static let surface = dynamic(light: NSColor(calibratedWhite: 0.955, alpha: 0.82), dark: NSColor(calibratedRed: 0.112, green: 0.126, blue: 0.154, alpha: 0.62))
    static let cardSurface = dynamic(light: NSColor(calibratedWhite: 0.835, alpha: 0.62), dark: NSColor(calibratedRed: 0.140, green: 0.155, blue: 0.180, alpha: 0.50))
    static let surfaceMuted = dynamic(light: NSColor(calibratedWhite: 0.925, alpha: 0.66), dark: NSColor(calibratedRed: 0.150, green: 0.170, blue: 0.205, alpha: 0.52))
    static let controlSurface = dynamic(light: NSColor(calibratedWhite: 0.955, alpha: 0.70), dark: NSColor(calibratedRed: 0.180, green: 0.202, blue: 0.242, alpha: 0.58))
    static let rowSurface = dynamic(light: NSColor(calibratedWhite: 0.955, alpha: 0.78), dark: NSColor(calibratedRed: 0.125, green: 0.140, blue: 0.170, alpha: 0.72))
    static let selectionSurface = dynamic(light: NSColor(calibratedWhite: 0.895, alpha: 0.84), dark: NSColor(calibratedRed: 0.185, green: 0.202, blue: 0.232, alpha: 0.76))
    static let selectionSurfaceRaised = dynamic(light: NSColor(calibratedWhite: 0.955, alpha: 0.84), dark: NSColor(calibratedRed: 0.270, green: 0.295, blue: 0.340, alpha: 0.90))
    static let localModelOptionSurface = dynamic(light: NSColor(calibratedWhite: 0.940, alpha: 0.68), dark: NSColor(calibratedRed: 0.175, green: 0.190, blue: 0.220, alpha: 0.62))
    ...
    static let iconTileSurface = dynamic(light: NSColor(calibratedWhite: 0.955, alpha: 0.62), dark: NSColor(calibratedRed: 0.210, green: 0.232, blue: 0.272, alpha: 0.62))
    static let border = dynamic(light: NSColor(calibratedWhite: 0.30, alpha: 0.22), dark: NSColor(calibratedWhite: 1.0, alpha: 0.115))
    static let textPrimary = dynamic(light: NSColor(calibratedWhite: 0.08, alpha: 1), dark: NSColor(calibratedRed: 0.925, green: 0.938, blue: 0.955, alpha: 1))
    static let textSecondary = dynamic(light: NSColor(calibratedWhite: 0.28, alpha: 1), dark: NSColor(calibratedRed: 0.670, green: 0.705, blue: 0.755, alpha: 1))
    static let textTertiary = dynamic(light: NSColor(calibratedWhite: 0.40, alpha: 1), dark: NSColor(calibratedRed: 0.500, green: 0.540, blue: 0.600, alpha: 1))
    ...
    static let glassScrim = dynamic(light: NSColor(calibratedWhite: 1.0, alpha: 0.66), dark: NSColor(calibratedRed: 0.075, green: 0.086, blue: 0.108, alpha: 0.62))
